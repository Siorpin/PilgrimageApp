...
import com.example.pielgrzymkabielskozywiecka.core.domain.daos.ConferencesDao
...
@Database(entities = [Prayers::class, Announcements::class, Songs::class, Conferences::class], version = 1)
